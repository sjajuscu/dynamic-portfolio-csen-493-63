...
// configure
$from = 'contact@myecompany.co.in'; // Replace it with Your Hosting Admin email. REQUIRED!
// $errorMessage = 'Contact form successfully submitted. Thank you, I will get back to you soon!';

// mail($sendTo, $subject, "Works", "Done");
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    if($responseData->success):
        try
        {
            $sendTo = $_POST['eto']; // Replace it with Your email. REQUIRED!
