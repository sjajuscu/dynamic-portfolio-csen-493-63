                    ...
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="title1">
                                ...
                                <input type="text" class="form-control" id="title" placeholder="Enter What you do Here" name="title" style="width: 100%;" autocomplete="off" />
                            </div>
                            <div id="" class="mt-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10 col-12">
                                        <div class="form-group mb-0">
                                            <label class="text-muted"> Enter Icon</label>
                                            <input type="text" class="form-control" name="url" id="cost" placeholder="fas fa-cart-plus" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-sm-2 col-12">
                                        <label class="text-muted">Icon List</label>
                                            <a href="./icons.php" target="_blank" class="btn btn-secondary">View Icons</a>
                                    </div>
                                </div>
                                <div>
